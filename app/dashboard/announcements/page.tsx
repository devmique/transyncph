    ...
    <div>
      ...
      {formOpen && (
        <div className="bg-slate-900/60 border border-white/8 rounded-xl p-6 mb-6">
          <h2 className="text-lg font-semibold text-slate-100 mb-5">{editingId ? 'Edit Announcement' : 'Create New Announcement'}</h2>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-3.5 py-2.5 bg-white/5 border border-white/10 rounded-lg text-slate-100 text-sm font-light placeholder:text-slate-500 focus:outline-none focus:border-blue-600 focus:bg-blue-600/5 transition resize-none"
              />
            </div>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-16 bg-slate-900/40 border border-white/5 rounded-xl">
          <Megaphone className="w-10 h-10 text-slate-500 mb-3" />
        ...
        <div className="space-y-3">
          {announcements.map((a) => {
            ...
            return (
              <div key={a._id} className="group bg-slate-900/60 border border-white/8 rounded-xl px-5 py-4 hover:border-white/12 transition">
      ...
      {deletingId && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="w-full max-w-sm bg-slate-900 border border-white/10 rounded-2xl p-6 shadow-2xl">
            ...
            <h3 className="text-lg font-semibold text-slate-100 text-center mb-2">Delete Announcement</h3>
